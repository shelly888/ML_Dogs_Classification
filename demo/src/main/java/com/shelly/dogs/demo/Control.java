...
import com.shelly.dogs.Audio;
import com.shelly.dogs.CameraOptions;
import com.shelly.dogs.CameraView;
import com.shelly.dogs.Flash;
import com.shelly.dogs.Gesture;
import com.shelly.dogs.GestureAction;
import com.shelly.dogs.Grid;
import com.shelly.dogs.Hdr;
import com.shelly.dogs.SessionType;
import com.shelly.dogs.VideoQuality;
import com.shelly.dogs.WhiteBalance;
...
public enum Control {
    ...
    public void applyValue(CameraView camera, Object value) {
        switch (this) {
            ...
            case AUDIO:
            case HDR:
                camera.set((com.shelly.dogs.Control) value);
                break;
            case CROP_OUTPUT:
